...
const isChromeApiAvailable = typeof chrome !== 'undefined' && typeof chrome.storage !== 'undefined';
const isLocalStorageAvailable = typeof localStorage !== 'undefined';

const extensionApi = isBrowserApiAvailable ? browser : isChromeApiAvailable ? chrome : null;
