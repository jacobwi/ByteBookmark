...
import { Loading, Avatar } from '@bookmarks/shared/ui';

import { useAuth } from '@bookmarks/shared/hooks';
import { useUser } from '@bookmarks/shared/contexts/UserContext';
import { userService } from '@bookmarks/shared/services';
